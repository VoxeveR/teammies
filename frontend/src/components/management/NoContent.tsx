...
export default function NoContent({ title, description, imageSrc = '../src/assets/logo.svg', children }: NoContentProps) {
      return (
            <div className='bg-quiz-white flex h-fit flex-col items-center justify-center rounded-2xl border p-8'>
                  ...
                  <div className='text-quiz-dark-green text-center'>
                        ...
                        <div className='text-quiz-dark-green text-xl'>{description}</div>
                  </div>
